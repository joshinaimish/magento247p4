...
class Edit extends \Nxtech\Blog\Controller\Adminhtml\Blog
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Nxtech\Blog\Model\Blog::class);
        ...
        $this->_coreRegistry->register('nxtech_blog', $model);
